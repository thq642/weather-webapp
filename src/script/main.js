...
function getCurrentWeather(kota) {
   return fetch(`https://api.openweathermap.org/data/2.5/weather?q=${kota}&units=metric&appid=51c4ad1835cf305c50d92c97dd7c0df9`)
      .then(response => {
         if (!response.ok) {
...
// Request One Call API yang merupakan API tempat menyimpan semua data cuaca termasuk hourly dan daily
function oneCallApi(lat, lon) {
   fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=metric&appid=51c4ad1835cf305c50d92c97dd7c0df9`)
